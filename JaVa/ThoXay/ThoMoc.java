...
public class ThoMoc extends ThoXay implements Serializable {
    ...
    public ThoMoc(String maNhanVien, int namKinhNghiem, int soChiNhanh, String chinhSachQuanLy, String diaChi) {
    ...
    public String toTextFormat() {
        return "Thợ Mộc," + super.toTextFormat() + "," + soChiNhanh + "," + diaChi + "," + chinhSachQuanLy;
    }
    @Override
    public Object[] toRowData() {
        return new Object[]{"Thợ Mộc",getmaNhanVien(), getnamKinhNghiem(), soChiNhanh, diaChi, chinhSachQuanLy};
    }


    @Override
    public String xuatThongTin1() {
        return "Thợ Mộc - Mã: " + getmaNhanVien() + ", Năm kinh nghiệm: " + getnamKinhNghiem()
